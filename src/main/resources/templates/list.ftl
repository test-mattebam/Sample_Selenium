	            ...
	            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
	                ...
	                <div class="row">
	                    <div class="form-actions floatRight">
	                        <input type="submit"  id="addOrUpdate" value="{{!ctrl.user.id ? 'Add' : 'Update'}}" class="btn btn-primary btn-sm" ng-disabled="myForm.$invalid || myForm.$pristine">
	                        <button type="button" id= "submit" ng-click="ctrl.reset()" class="btn btn-warning btn-sm" ng-disabled="myForm.$pristine">Reset Form</button>
	                    </div>
	                </div>
	            </form>
    	    </div>
			...
			<div class="table-responsive">
		        <table class="table table-hover" id="usersList" >
		            ...
		            <tr ng-repeat="u in ctrl.getAllUsers()">
		                ...
		                <td>{{u.age}}</td>
		                <td>{{u.salary}}</td>
		                <td><button id="edit" type="button" ng-click="ctrl.editUser(u.id)" class="btn btn-success custom-width">Edit</button></td>
		                <td><button id="remove" type="button" ng-click="ctrl.removeUser(u.id)" class="btn btn-danger custom-width">Remove</button></td>
		            </tr>
		            </tbody>
		        </table>		
			</div>
